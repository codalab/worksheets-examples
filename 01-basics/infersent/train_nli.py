...
# paths
parser.add_argument("--nlipath", type=str, default='infersent/dataset/SNLI/', help="NLI data path (SNLI or MultiNLI)")
parser.add_argument("--outputdir", type=str, default='experiments/', help="output directory")
parser.add_argument("--outputmodelname", type=str, default='model.pickle')
parser.add_argument("--word_emb_path", type=str, default="infersent/dataset/GloVe/glove.840B.300d.txt", help="word embedding file path")
