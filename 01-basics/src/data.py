...
def get_nli(data_path, use_frac={}):
    s1 = {}
    s2 = {}
    target = {}
    ...
    for data_type in ['train', 'dev', 'test']:
        ...
        # subsample data
        if data_type in use_frac:
            cutoff = int(len(target[data_type]['data']) * use_frac[data_type])
            s1[data_type]['sent'] = s1[data_type]['sent'][:cutoff]
            s2[data_type]['sent'] = s2[data_type]['sent'][:cutoff]
            target[data_type]['data'] = target[data_type]['data'][:cutoff]
